...
def resize_window_aspect_ratio(window_name, width, height):
    """Resizing of window to maintain a 9:16 aspect ratio."""
    aspect_ratio = 9 / 16
...
def analyze_skin_type():
    ...
    # setting of the window to be resizable
    window_name = 'Webcam'
    cv2.namedWindow(window_name, cv2.WINDOW_NORMAL)

    # setting of initial size to maintain a 9:16 aspect ratio
    initial_width = 540
    initial_height = 960
    ...
    while True:
        ...
        if faces:
            ...
            #calculating of the distance from the camera
            ...
            if 20 <= distance <= 30:
                ...
                # using the latest predictions to update the display text
                ...
                # displaying of the prediction text on the frame
